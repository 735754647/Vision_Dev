#ifndef _INCLUDE_AUTOCSDExVisionDev_HIK_INTERFECE_H_
#define _INCLUDE_AUTOCSDExVisionDev_HIK_INTERFECE_H_

#include "../../AutoCSD_include/AutoCSD/SMCVStruct.h"
#include "../CSDExVisionDev.h"

class CSDExVisionDev_HIK:
	public CSDExVisionDev
{
public:
	CSDExVisionDev_HIK(void);
	~CSDExVisionDev_HIK(void);
...
public:
	...
	//图像格式
	long scvSetImageFormat(long _format);
...
private:
	LPVOID m_CSDExVisionDev_HIK;
};

#endif //_INCLUDE_AUTOCSDExVisionDev_HIK_INTERFECE_H_