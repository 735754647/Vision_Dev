...
INDCAM_LABVIEW_API int _stdcall HV_LabVIEWSaveParaToIniFile(int nDevId);
...
/******************************************************************************
* Function:	HV_LabVIEWGetResolution
* Description: 获取设置视频的分辨率
* Format:
*      HV_LabVIEWGetResolution(int* pnVideoWidth, int* pnVideoHeight,int nDevId);
* Params:
*     int pnVideoWidth: ROI的宽度
*     int pnVideoHeight: ROI的高度
*     int nDevId: 设备索引号
* Return:
*     HV_SUCCESS: 成功
*	  HVOCX_INVALID_PARAM: 无效参数
...
/******************************************************************************
* Function:	HV_LabVIEWGetROI
* Description: 获取视频的ROI(Region of Interest)
* Format:
*      HV_LabVIEWGetROI(int *nStart_x, int *nStart_y, 
*				  int *nImgWidth, int *nImgHeight,int nDevId);
* Params:
...
*      HV_NO_SUCH_DEVICE: 没有找到对应的硬件设备
******************************************************************************/
INDCAM_LABVIEW_API HRESULT __stdcall HV_LabVIEWGetROI(int *nStart_x, int *nStart_y, 
										  int *nImgWidth, int *nImgHeight,int nDevId);
...
* Format:
*     HRESULT HV_LabVIEWSetPacketSize(int nPacketSize,int nDevId)
* Params:
...
INDCAM_LABVIEW_API int __stdcall HV_LabVIEWSetPacketSize(int nPacketSize, int nDevId);

/******************************************************************************
* Function:	HV_LabVIEWGetTriggerCount()
* Description: 触发计数
* Format:
*     int HV_LabVIEWGetTriggerCount(int *ImgCount, bool bReset, int nDevId)
* Params:
*     int ImgCount:  触发计数（包含软硬件触发）
*     bool bReset:   计数重置（为True时重置）
*     int nDevId: 设备索引号
* Return: 
*     HV_SUCCESS: 成功
*     HVOCX_INVALID_PARAM: 无效参数
*     HVOCX_DEVICE_START_FAIL: 开启设备失败
******************************************************************************/
INDCAM_LABVIEW_API int __stdcall HV_LabVIEWGetTriggerCount(int *ImgCount, bool bReset, int nDevId);

/******************************************************************************
* Function:	HV_LabVIEWSetGrrMode_ExpFlash()
* Description: 设置Drr模式下的曝光时间与控制闪光灯灭的延迟时间
* Format:
*     HRESULT HV_LabVIEWSetGrrMode_ExpFlash(long lExposureTime, long lFlashDelayTime, int nDevId)
* Params:
...
INDCAM_LABVIEW_API int __stdcall HV_LabVIEWSetGrrMode_ExpFlash(int lExposureTime, int lFlashDelayTime, int nDevId);

/******************************************************************************
* Function:	HV_LabVIEWSetImageDataType
* Description: 设置相机输出的图像格式
* Format:
*     HRESULT HV_LabVIEWSetImageDataType(int nDevId) ;
* Params:
*     void
* Return: 
*     HV_SUCCESS: 成功
...
INDCAM_LABVIEW_API int __stdcall HV_LabVIEWSetImageDataType(int nDevId, int nImgDataType);

/******************************************************************************
* Function:	HV_LabVIEWGetCameraType()
* Description: 得到当前相机型号(Camera Type),如：HV130GM等
* Format:
*     int HV_LabVIEWGetCameraType(int nDevId)
* Params:
*     int nDevId  设备索引
* Return: 
*     成功：返回Camera Type，否则返回0
******************************************************************************/
INDCAM_LABVIEW_API CAMERA_TYPE __stdcall HV_LabVIEWGetCameraType(int nDevId);

/******************************************************************************
* Function:	HV_LabVIEWSetBrightnessFactor()
* Description: 设置相机亮度
* Format:
*     HV_LabVIEWSetBrightnessFactor(float Brightness, int nDevId)
* Params:
...
******************************************************************************/
INDCAM_LABVIEW_API HRESULT __stdcall HV_LabVIEWSetBrightnessFactor(float Brightness, int nDevId);

/******************************************************************************
* Function:	HV_LabVIEWGetBrightnessFactor()
* Description: 获取当前相机亮度值
* Format:
*     HV_LabVIEWGetBrightnessFactor(float &Brightness, int nDevId)
* Params:
*	  float &Brightness		亮度        有效范围(-1,1]  
*     int nDevId  设备索引
* Return: 
...
******************************************************************************/
INDCAM_LABVIEW_API HRESULT __stdcall HV_LabVIEWGetBrightnessFactor(float *Brightness, int nDevId);

/******************************************************************************
* Function:	HV_LabVIEWSetContrastFactor()
* Description: 设置相机对比度
* Format:
*     HV_LabVIEWSetContrastFactor(float Constrast, int nDevId)
* Params:
...
*     成功：return HV_SUCCESS; 若输入值超出范围则默认为-0.94和1
******************************************************************************/
INDCAM_LABVIEW_API HRESULT __stdcall HV_LabVIEWSetContrastFactor(float Constrast, int nDevId);

/******************************************************************************
* Function:	HV_LabVIEWGetContrastFactor()
* Description: 设置相机对比度
* Format:
*     HV_LabVIEWGetContrastFactor(float &Constrast, int nDevId)
* Params:
*	  float Constrast       对比度		有效范围(-1,1]
*     int nDevId  设备索引
* Return: 
*     成功：return HV_SUCCESS; 若输入值超出范围则默认为-0.94和1
******************************************************************************/
INDCAM_LABVIEW_API HRESULT __stdcall HV_LabVIEWGetContrastFactor(float *Constrast, int nDevId);

/******************************************************************************
* Function:	HV_LabVIEWAKeyWhiteBalance()
* Description: 一键白平衡
* Format:
*     HV_LabVIEWAKeyWhiteBalance(int nDevId)
* Params:
*     int nDevId  设备索引
* Return: 
*     成功：return HV_SUCCESS; 注：只针对彩色相机
******************************************************************************/
INDCAM_LABVIEW_API HRESULT __stdcall HV_LabVIEWAKeyWhiteBalance(int nDevId);

/******************************************************************************
* Function:	HV_LabVIEWSetUserDefNum()
* Description: 设置用户自定义序列号
* Format:
*     HRESULT HV_LabVIEWSetUserDefNum(LPSTR lpSeriesNum,int nDevId)
* Params:
...
*     HV_SUCCESS: 成功
******************************************************************************/
INDCAM_LABVIEW_API HRESULT __stdcall HV_LabVIEWSetUserDefNum(LPSTR lpSeriesNum, int nDevId);

/******************************************************************************
* Function:	HV_LabVIEWGetUserDefNum()
* Description: 获取用户自定义序列号
* Format:
*     HRESULT HV_LabVIEWGetUserDefNum(LPSTR lpSeriesNum,int nDevId)
* Params:
...
*     HV_SUCCESS: 成功
******************************************************************************/
INDCAM_LABVIEW_API HRESULT __stdcall HV_LabVIEWGetUserDefNum(LPSTR lpSeriesNum, int nDevId);

/******************************************************************************
* Function:	HV_LabVIEWSetGPIOMode(int nMode, int nDevId)
* Description: 选择GPIO输出类型
* Format:
*     HRESULT  HV_LabVIEWSetGPIOMode(int nMode, int nDevId)
* Params:
...
******************************************************************************/
INDCAM_LABVIEW_API HRESULT __stdcall HV_LabVIEWSetGPIOMode(int nMode, int nDevId);

/******************************************************************************
* Function:	HV_LabVIEWSetGPIOValue(bool bValue, int nDevId)
* Description: 选择GPIO输出类型
* Format:
*     HRESULT  HV_LabVIEWSetGPIOValue(bool bValue, int nDevId)
* Params:
...
*     HV_UNSUCCESS: 失败
******************************************************************************/
INDCAM_LABVIEW_API HRESULT __stdcall HV_LabVIEWSetGPIOValue(bool bValue, int nDevId);

/******************************************************************************
* Function:	HV_LabVIEWGetMaxFrameRate()
* Description: 获取当前相机能够输出的最大帧率
* Format:
*     HRESULT  HV_LabVIEWGetMaxFrameRate(int &nMaxFrameRate, int nDevId)
* Params:
...
******************************************************************************/
INDCAM_LABVIEW_API HRESULT __stdcall HV_LabVIEWGetMaxFrameRate(int *nMaxFrameRate, int nDevId);


/******************************************************************************
* Function:	HV_LabVIEWGetFatorySeriesNum()
* Description: 获取相机出厂序列号
* Format:
*     HRESULT HV_LabVIEWGetFatorySeriesNum(LPSTR lpSeriesNum,int nDevId)
* Params:
*     LPCSTR lpSeriesNum : 返回用户设定序列号
*	  int nDevId : 相机索引号
* Return: 
...
INDCAM_LABVIEW_API HRESULT __stdcall HV_LabVIEWGetFatorySeriesNum(LPSTR lpSeriesNum, int nDevId);
