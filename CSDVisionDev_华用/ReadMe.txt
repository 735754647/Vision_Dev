========================================================================
    MICROSOFT 基础类库 : CSDVisionDev 项目概述
========================================================================


应用程序向导已为您创建了此 CSDVisionDev DLL。  此 DLL 不仅演示 
Microsoft 基础类的基本使用方法，还可作为您编写 DLL 的起点。

本文件概要介绍组成 CSDVisionDev DLL 的每个文件的内容。

CSDVisionDev.vcxproj
    这是使用应用程序向导生成的 VC++ 项目的主项目文件，
    其中包含生成该文件的 Visual C++ 
    的版本信息，以及有关使用应用程序向导选择的平台、配置和项目功能的信息。

CSDVisionDev.vcxproj.filters
...
StdAfx.h，StdAfx.cpp
    这些文件用于生成名为 CSDVisionDev.pch 的预编译头 (PCH) 文件和名为 
    StdAfx.obj 的预编译类型文件。
