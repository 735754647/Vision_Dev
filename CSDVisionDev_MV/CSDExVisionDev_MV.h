#ifndef _INCLUDE_AUTOCSDExVisionDev_MV_INTERFECE_H_
#define _INCLUDE_AUTOCSDExVisionDev_MV_INTERFECE_H_

#include "../../AutoCSD_include/AutoCSD/SMCVStruct.h"
#include "../CSDExVisionDev.h"

class CSDExVisionDev_MV:
	public CSDExVisionDev
{
public:
	CSDExVisionDev_MV(void);
	~CSDExVisionDev_MV(void);
...
private:
	LPVOID m_CSDExVisionDev_MV;
};

#endif //_INCLUDE_AUTOCSDExVisionDev_MV_INTERFECE_H_